...
$(window).on('load', function() {
    ...
    var hddSparkline = function() {
        $("#gsp-sparkline-area").sparkline([57,69,70,62,73,79,76,77,73,52,57,50,60,55,70,68], {
            type: 'line',
            width: '100%',
            height: '40',
            spotRadius: 5,
    ...
    var earningSparkline = function(){
        $("#gsp-sparkline-line").sparkline([345,404,305,455,378,567,586,685,458,742,565], {
            type: 'line',
            width: '100%',
            height: '40',
            spotRadius: 4,
    ...
    // =================================================================
    $('#gsp-panel-network-refresh').niftyOverlay().on('click', function(){
        var $el = $(this), relTime;
