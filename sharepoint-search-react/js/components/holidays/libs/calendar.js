...
(function($) {
	...
	function buildEventsUrl(events_url, data) {
		...
		url += separator + " start ge '" + encodeURIComponent(data.start);
		url += "' and end le '" + encodeURIComponent(data.end)+"' ";
	...
	Calendar.prototype._loadTemplate = function(name) {
		if(typeof (this.options.templates[name]) != "function") {
            this.options.templates[name] = _.template(this.options.templates[name]);
			return;
		}
		// var self = this;
		// $.ajax({
